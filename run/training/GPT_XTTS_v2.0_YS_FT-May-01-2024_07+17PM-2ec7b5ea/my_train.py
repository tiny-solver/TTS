...
config_dataset = BaseDatasetConfig(
    formatter="ljspeech",
    dataset_name="ys_v1",
    path="/home/choigawoon/tiny-solver/study/TTS/mywork/yoonseul",
    meta_file_train="/home/choigawoon/tiny-solver/study/TTS/mywork/yoonseul/metadata_ys.txt",
    # path="/mnt/g/dataset/tts/choigawoon",
    # meta_file_train="/mnt/g/dataset/tts/choigawoon/metadata.txt",
    language="ko",
)
...
SPEAKER_REFERENCE = [
    ...
    "/home/choigawoon/tiny-solver/study/TTS/mywork/yoonseul/wavs/audio15.wav"
]
...
def main():
    ...
    config = GPTTrainerConfig(
        ...
        run_description="""
            GPT XTTS training for yoonseul
            """,
